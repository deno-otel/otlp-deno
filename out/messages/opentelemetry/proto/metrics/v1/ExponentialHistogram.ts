// @ts-nocheck
import {
  Type as ExponentialHistogramDataPoint,
  encodeJson as encodeJson_1,
  decodeJson as decodeJson_1,
  encodeBinary as encodeBinary_1,
  decodeBinary as decodeBinary_1,
} from "./ExponentialHistogramDataPoint.ts";
import {
...
export type Type = $.opentelemetry.proto.metrics.v1.ExponentialHistogram;

export function getDefaultValue(): $.opentelemetry.proto.metrics.v1.ExponentialHistogram {
  return {
    dataPoints: [],
...
export function createValue(partialValue: Partial<$.opentelemetry.proto.metrics.v1.ExponentialHistogram>): $.opentelemetry.proto.metrics.v1.ExponentialHistogram {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.opentelemetry.proto.metrics.v1.ExponentialHistogram): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.opentelemetry.proto.metrics.v1.ExponentialHistogram {
...
export function encodeBinary(value: $.opentelemetry.proto.metrics.v1.ExponentialHistogram): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.opentelemetry.proto.metrics.v1.ExponentialHistogram {
  const result = getDefaultValue();
