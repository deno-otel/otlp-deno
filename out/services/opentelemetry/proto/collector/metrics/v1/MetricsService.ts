...
import {
  Type as ExportMetricsServiceRequest,
  encodeBinary,
  decodeBinary,
  encodeJson,
} from "../../../../../../messages/opentelemetry/proto/collector/metrics/v1/ExportMetricsServiceRequest.ts";
import {
  Type as ExportMetricsServiceResponse,
  encodeBinary as encodeBinary_1,
  decodeBinary as decodeBinary_1,
  encodeJson as encodeJson_1,
} from "../../../../../../messages/opentelemetry/proto/collector/metrics/v1/ExportMetricsServiceResponse.ts";
import {
  fromSingle,
  first,
...
export interface Service<TReqArgs extends any[] = [], TResArgs extends any[] = []> {
  export(request: ExportMetricsServiceRequest, ...args: TReqArgs): RpcReturnType<Promise<ExportMetricsServiceResponse>, TResArgs>;
}
...
export const methodDescriptors = {
  export: {
    methodName: "Export",
    service: { serviceName: "opentelemetry.proto.collector.metrics.v1.MetricsService" },
    requestStream: false,
    responseStream: false,
    requestType: {
      serializeBinary: encodeBinary,
      deserializeBinary: decodeBinary,
      serializeJson: (value: ExportMetricsServiceRequest) => JSON.stringify(encodeJson(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_1,
      deserializeBinary: decodeBinary_1,
      serializeJson: (value: ExportMetricsServiceResponse) => JSON.stringify(encodeJson_1(value)),
    },
  },
} as const;
