...
import {
  Type as ExportLogsServiceRequest,
  encodeBinary,
  decodeBinary,
  encodeJson,
} from "../../../../../../messages/opentelemetry/proto/collector/logs/v1/ExportLogsServiceRequest.ts";
import {
  Type as ExportLogsServiceResponse,
  encodeBinary as encodeBinary_1,
  decodeBinary as decodeBinary_1,
  encodeJson as encodeJson_1,
} from "../../../../../../messages/opentelemetry/proto/collector/logs/v1/ExportLogsServiceResponse.ts";
import {
  fromSingle,
  first,
...
export interface Service<TReqArgs extends any[] = [], TResArgs extends any[] = []> {
  export(request: ExportLogsServiceRequest, ...args: TReqArgs): RpcReturnType<Promise<ExportLogsServiceResponse>, TResArgs>;
}
...
export const methodDescriptors = {
  export: {
    methodName: "Export",
    service: { serviceName: "opentelemetry.proto.collector.logs.v1.LogsService" },
    requestStream: false,
    responseStream: false,
    requestType: {
      serializeBinary: encodeBinary,
      deserializeBinary: decodeBinary,
      serializeJson: (value: ExportLogsServiceRequest) => JSON.stringify(encodeJson(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_1,
      deserializeBinary: decodeBinary_1,
      serializeJson: (value: ExportLogsServiceResponse) => JSON.stringify(encodeJson_1(value)),
    },
  },
} as const;
